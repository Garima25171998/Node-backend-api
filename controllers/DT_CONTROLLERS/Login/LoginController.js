const userModel=require('../../../models/DT_MODELS/LoginModel');
const OtpModel=require('../../../models/DT_MODELS/OtpSendModel')
...
module.exports={loginUser,CheckUserEmail,SendMail,VerifyOtp,getUser}